...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('questions_question', 'answers', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question.answers'
        db.delete_column('questions_question', 'answers')
    ...
    models = {
        ...
        'questions.question': {
            ...
            'answers': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
